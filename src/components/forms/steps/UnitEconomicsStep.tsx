...
export function UnitEconomicsStep({ control }: { control: Control<ProjectFormValues> }) {
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <AssumptionField control={control} name="unitEconomics.revenuePerCustomer" label="Revenue per customer" prefix="$" description="Typically the same as your monthly ARPU." />
